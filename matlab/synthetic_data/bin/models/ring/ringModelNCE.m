function [ out1, varargout ]  = ringModelNCE(X, theta, varargin)
...
%   This version for NCE also include the partition function as a parameter
...
if (nargout > 1 || outputflag == 1)
    ...
    grad_prec = -0.5 .* argSq;
    grad_c = ones(size(r,1), 1);
 
	logGrad_t = [grad_mu, grad_prec, grad_c];
